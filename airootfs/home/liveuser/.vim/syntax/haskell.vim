...
" Strings and constants syn match   hsSpecialChar	contained "\\\([0-9]\+\|o[0-7]\+\|x[0-9a-fA-F]\+\|[\"\\'&\\abfnrtv]\|^[A-Z^_\[\\\]]\)"
...
" Comments
syn keyword hsTodo contained TODO FIXME XXX NOTE
syn match   hsLineComment      "---*\([^-!#$%&\*\+./<=>\?@\\^|~].*\)\?$" contains=hsTodo
syn region  hsBlockComment     start="{-"  end="-}" contains=hsBlockCommen,hsTodot
syn region  hsPragma	       start="{-#" end="#-}" contains=hsTodo
